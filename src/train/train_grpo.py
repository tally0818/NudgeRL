...
def main():
    ...
    num_rollouts = args.num_rollouts if args.num_rollouts is not None else cfg["context_grpo"]["num_rollouts"]
    ...
    algorithm_name = f"GRPO_{num_rollouts}_eps{eps_high*100:.0f}"
    ...
    training_args = GRPOConfig(
        ...
        gradient_accumulation_steps=int(num_rollouts/8),
        num_generations=num_rollouts,
        generation_batch_size=num_rollouts, 
